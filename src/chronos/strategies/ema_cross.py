...
from chronos.strategies.base import IndicatorStrategy
from chronos.strategies.indicators import atr, ema
from chronos.strategies.registry import register
