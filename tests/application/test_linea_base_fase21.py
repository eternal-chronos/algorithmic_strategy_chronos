...
La línea base se reconstruye desde el fichero del proyecto con `phase1_config`:
el fichero corre la estructura con la regla encendida y el ID también en H1, y
lo que aquí se enciende y se apaga es la regla sobre el reparto de la fase 1.
...
def test_la_linea_base_lleva_la_regla_nueva_apagada(config: ImpulseConfig) -> None:
    """Es el primer cambio de comportamiento del proyecto: la línea base va sin él."""
